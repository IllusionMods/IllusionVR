...
namespace VRGIN.Core
{
    ...
    public class VRSettings
    {
        ...
        public float Distance { get => _Distance; set { _Distance = Mathf.Clamp(value, 0.1f, 10f); TriggerPropertyChanged("Distance"); } }
        ...
        public float Angle { get => _Angle; set { _Angle = Mathf.Clamp(value, 50f, 360f); TriggerPropertyChanged("Angle"); } }
        ...
        public float IPDScale { get => _IPDScale; set { _IPDScale = Mathf.Clamp(value, 0.01f, 50f); TriggerPropertyChanged("IPDScale"); } }
        ...
        public float OffsetY { get => _OffsetY; set { _OffsetY = value; TriggerPropertyChanged("OffsetY"); } }
        ...
        public float Rotation { get => _Rotation; set { _Rotation = value; TriggerPropertyChanged("Rotation"); } }
        ...
        public bool Rumble { get => _Rumble; set { _Rumble = value; TriggerPropertyChanged("Rumble"); } }
        ...
        public float RenderScale { get => _RenderScale; set { _RenderScale = Mathf.Clamp(value, 0.1f, 4f); TriggerPropertyChanged("RenderScale"); } }
        private float _RenderScale = 1f;

        [XmlComment("Whether or not to display anything on the mirror screen. (Broken)")]
        public bool MirrorScreen { get => _MirrorScreen; set { _MirrorScreen = value; TriggerPropertyChanged("MirrorScreen"); } }
        ...
        public bool PitchLock { get => _PitchLock; set { _PitchLock = value; TriggerPropertyChanged("PitchLock"); } }
        ...
        public CurvinessState Projection { get => _Projection; set { _Projection = value; TriggerPropertyChanged("Projection"); } }
        ...
        public bool SpeechRecognition { get => _SpeechRecognition; set { _SpeechRecognition = value; TriggerPropertyChanged("SpeechRecognition"); } }
        ...
        public string Locale { get => _Locale; set { _Locale = value; TriggerPropertyChanged("Locale"); } }
        ...
        public bool Leap { get => _Leap; set { _Leap = value; TriggerPropertyChanged("Leap"); } }
        ...
        public bool GrabRotationImmediateMode { get => _GrabRotationImmediateMode; set { _GrabRotationImmediateMode = value; TriggerPropertyChanged("GrabRotationImmediateMode"); } }
        ...
        public float RotationMultiplier { get => _RotationMultiplier; set { _RotationMultiplier = value; TriggerPropertyChanged("RotationMultiplier"); } }
        ...
        public virtual Shortcuts Shortcuts { get => _Shortcuts; protected set => _Shortcuts = value; }
        private Shortcuts _Shortcuts = new Shortcuts();


        public CaptureConfig Capture { get => _CaptureConfig; protected set => _CaptureConfig = value; }
        ...
        public bool ApplyEffects { get => _ApplyEffects; set => _ApplyEffects = value; }
        private bool _ApplyEffects = true;

        [XmlComment("Blacklist of effects that are to be disable (because they don't look good in VR).")]
        public string[] EffectBlacklist { get => _EffectBlacklist; set => _EffectBlacklist = value; }
