...
namespace KKCharaStudioVR
{
	public class VRCameraMoveHelper : MonoBehaviour
	{
		...
		public static VRCameraMoveHelper Instance
		{
			get
			{
				return VRCameraMoveHelper._instance;
			}
		}
		...
		private void OnGUI()
		{
			if (showGUI && menuRect != null && menuRect.gameObject.activeInHierarchy)
			{
				...
				try
				{
					...
					{
						windowRect = new Rect((float)(Screen.width / 2), 60f * menuRect.lossyScale.y, 400f, 100f);
					}
